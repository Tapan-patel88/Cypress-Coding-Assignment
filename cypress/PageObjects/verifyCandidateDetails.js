class verifyCandidateDetails{
    ...
    verifyCandidateNameTxt = ".oxd-table-body>div:first-child >div >div:nth-child(3)"
    eyeBtnTxt = ".oxd-table-body>div:first-child >div >div:nth-child(7)>div>button:first-child" 
